...
$abc=$query['id_nilai'];
	  ?></div></td>
    <td style="background-color: #bbffb9;color: black;"><?php echo $rows ?></td>
	  <td style="background-color: #bbffb9;color: black;" ><div><?php if($rata>=90){?><a class="btn btn-green btn-ok" onclick="return confirm('Print ?')" href="<?php  echo base_url('index.php/cetak/kelas/?id_nilai='.$abc.'&rows='.$rows);?>" target="_blank"><b>Cetak</b></a><?php } ?></div></td>
