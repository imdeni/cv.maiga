...
$sql = "SELECT * FROM tb_nilai where NISM='$s' order by rata desc";
...
<?php 
$rows = 1;
$sqll = "SELECT * FROM tb_nilai order by rata desc";
...
<pre>
  ...
  <p><b>          Nama          : <?php echo $aaa; ?></b></p>
  <p><b>          Kelas          : <?php echo $bbb; ?></b></p>
  <p><b>          Surat keterangan ini diberikan karena yang bersangkutan mendapatkan predikat siswa berprestasi peringkat <?php echo $rowss; ?> paralel dengan jumlah nilai <?php echo $ttl;?></b></p>
  <center><form method="post" action="<?php echo base_url('index.php/cetak/?id_nilai=').$ccc.'&rows='.$rowss; ?>" target="_blank"><?php if($rata>=90){?><button>Cetak</button><?php } ?></form></center>
</pre>
</div>
