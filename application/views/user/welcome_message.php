...
<input type="text" id="cari4" onkeyup="myFunction4()" placeholder="CARI KELAS">
...
<tr>
	...
	<td style="background-color:white;color: black;text-align: center;" ><b><div class="tengah"><?php echo $no  ?></div></b></td>
...
<?php $rata=$query['rata']; ?>
	<td style="text-align: center;color: black;" ><b><div class="tengah"><?php echo $total_NP  ?></div></b></td>
	<td style="text-align: center;color: black;" ><b><div class="tengah"><?php echo $total_NK ?></div></b></td>
	<td style="text-align: center;color: black;" ><b><div class="tengah"><?php echo number_format($rata,2);  ?></div></b></td>
	<td style="text-align: center;color: black;" ><div class="tengah"><?php echo $rows; ?></div></td>
