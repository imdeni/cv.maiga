...
<h1 style="font-size: 16px;padding-left:120px;color:black;">2. Surat Keterangan ini diberikan karena yang bersangkutan mendapatkan predikat <b>Siswa Berprestasi Peringkat <?php echo $rows; ?> Paralel dengan Jumlah Nilai <?php echo $ttl; ?> dan peringkat <?php echo$_GET['rowss'];  ?> kelas.</b></h1>
<br>
