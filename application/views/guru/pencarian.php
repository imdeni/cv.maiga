...
<br><br><br><br><br>
<p><center><b style="font-size:24px;">Pencarian Siswa</b></center></p><br>
<p><center><b style="font-size:16px;">Pencarian Berdasarkan Nama</b></center></p>
<center><input type="text" id="cari2" onkeyup="myFunction2()" placeholder="CARI NAMA"></center>
<br>

<p><center><b style="font-size:16px;">Pencarian Berdasarkan Kelas</b></center></p>
<center><select style="width: 200px;" name="" id="cari" onchange="myFunction();">
...
<center><form action="<?php echo base_url('index.php/nilai/pencarian') ?>" method="post"><button>Refresh</button></form></center>
<br><br>
<pre>
