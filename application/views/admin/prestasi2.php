...
<br><form method="post"><label style="font-weight: bold;font-family: 'Open Sans', Arial, sans-serif;">Silahkan pilih jumlah siswa dengan nilai teratas yang ingin di tampilkan</label>&nbsp<input type="number" name="jml"><button name="submit">Submit</button></form>
...
while ($query=mysqli_fetch_array($nilai)) {
  ...
  <td style="background-color:white;color: black;" ><b><div>'.$no.'</div></b></td>
  <td  style="background-color: white;" ><div>'.$yz3.'</div></td>
  <td style="width: 100px;background-color: white;text-align: left;" >'.$yz2.'</td>                  
  <td  style="background-color: white;" ><div>'.$yz.'</div></td>';
?>
...
<?php $rata=$query['rata']; ?>
  ...
  <td style="color: black;" ><b><div><?php echo $total_NP  ?></div></b></td>
  <td style="color: black;" ><b><div><?php echo $total_NK ?></div></b></td>
  <td style="color: black;" ><b><div><?php echo number_format($rata,2);  ?></div></b></td>
  <td style="color: black;"> <?php echo $rows; ?></td>
...
<?php 
  ...
  ?>
<form method="post" action="<?php echo base_url('index.php/printjml/?j=').$jmlll; ?>" target="_blank"><button name="print">Print</button></form>
<br>
<pre>
<table id="search" width="100%">
