...
<br><br><br><br><br>
<p><center><b style="font-size:30px;">Pencarian Siswa</b></center></p><br>
<p><center><b style="font-size:16px;">Pencarian Berdasarkan Nama <input type="text" id="cari2" onkeyup="myFunction2()" placeholder="CARI NAMA"></center></b></p>

<p><center><b style="font-size:16px;">Pencarian Berdasarkan Kelas
...
</select></center></b></p><br>
<center><form action="<?php echo base_url('index.php/Admin/pencarian') ?>" method="post"><button>Refresh</button></form></center>
<br><br>
<pre>
